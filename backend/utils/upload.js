...
const universalStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        let dir = './views/uploads/documents'; // default
        if (file.mimetype.startsWith('image/')) dir = './views/uploads/images';
        if (file.mimetype.startsWith('video/')) dir = './views/uploads/videos';
...
module.exports = { uploadPdf, uploadImage, uploadVideo, uploadUniversal };